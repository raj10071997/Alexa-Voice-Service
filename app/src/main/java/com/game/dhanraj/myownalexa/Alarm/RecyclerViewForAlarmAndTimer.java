...
public class RecyclerViewForAlarmAndTimer extends RecyclerView.Adapter<RecyclerViewForAlarmAndTimer.ViewHolder> {

    private LayoutInflater layoutInflater;
    private ArrayList<AlarmConstants> myConstants;
    private DataBase db;

    public RecyclerViewForAlarmAndTimer(Context context){
    ...
    @Override
    public RecyclerViewForAlarmAndTimer.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(RecyclerViewForAlarmAndTimer.ViewHolder holder, int position) {
