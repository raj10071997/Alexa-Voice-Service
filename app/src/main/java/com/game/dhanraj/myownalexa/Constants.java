...
public class Constants {
    ...
    public final static String BASE_THEME = "base_theme";
    public final static String BASE_THEME_INTEGER = "base_theme_integer";
    public static final int LIGHT_THEME = 1, DARK_THEME = 2;
